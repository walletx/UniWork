...
RESET:
	...
	do_lcd_command 0b10000100 ;	Makes input in entry mode start at 5th space
...
//Keypad Handling
keypad:	 ; disable interrupts so the keyboard scan is uninterrupted
