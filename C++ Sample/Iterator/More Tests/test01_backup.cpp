...
const long kMinInteger = 1;
const long kMaxInteger = 100;
...
int main(void) {
  ...
  //insertRandomNumbers(testContainer, stableContainer, 10);
  insertRandomNumbers(testContainer, stableContainer, 10);
  //testContainer.insert(10);

  std::cout << "Finding 10" << std::endl;
  bool foundInTree = (testContainer.find(10) != testContainer.end());
