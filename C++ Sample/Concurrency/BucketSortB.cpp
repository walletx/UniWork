...
void BucketSort::sort(unsigned int numCores) {
    ...
    auto partition_lambda = [this, &set_size, &numCores, &shared_buckets, &bucket_mutexes] (unsigned int threadNum) {
        ...
        // Dump into buckets starting at first bucket in that order
        // No noticeable performance difference than when using more complex methods
        // This one seems safer and more maintanable so I went with the for-loop
