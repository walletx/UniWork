...
(GBAT9101,06s2,23343,8616,"Project Management",80,DN,6,1,19)
(GBAT9106,07s1,27143,8616,"Information Systems Mgt",73,CR,6,1,9)
(GBAT9120,07s1,27147,8616,"Accounting: A User Perspective",85,HD,6,1,9)
(GBAT9117,07s2,30320,8616,"E-Business Strategy & Mgmnt",71,CR,6,1,13)
(GBAT9115,08s1,34056,8616,"IT in Business",62,PS,6,1,27)
(GBAT9130,08s1,34063,8616,"Enterprise Risk Management",86,HD,6,1,14)
(GBAT9127,08s2,37459,8616,"Supply Chain Management",36,FL,0,1,11)
(GBAT9123,09s2,44435,8616,"Fundamentals Corporate Finance",88,HD,6,1,30)
(GBAT9119,10x1,46854,8616,"Managing for Org Sust",45,FL,0,1,13)
(GBAT9126,11s1,55267,8616,"Develop New Products &Services",40,FL,0,1,22)
(GBAT9127,11s2,58482,8616,"Supply Chain Management",,NC,6,,20)
(GBAT9129,12s1,62192,8616,"Managing Org Resources",31,FL,0,1,18)
